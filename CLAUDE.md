...
This project is indexed by GitNexus as **asciiquarium-js** (328 symbols, 525 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/asciiquarium-js/context` | Codebase overview, check index freshness |
| `gitnexus://repo/asciiquarium-js/clusters` | All functional areas |
| `gitnexus://repo/asciiquarium-js/processes` | All execution flows |
| `gitnexus://repo/asciiquarium-js/process/{name}` | Step-by-step execution trace |
